...
**We can see that the density for countries where higher languages are spoken,the obesetiy count is lowerH is for that country** 
...
**Seing this graphic we can see that countries with more languages spoken have more internet on the general but not drastrically.**
