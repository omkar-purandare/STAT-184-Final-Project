...
**The renaming of variables in the Languages Data Frame - 110**

(B) .Rmd Line number(s) for a join operation:   
**130 - Joining both Data sets**    

(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):  
**235 mosaic::ntiles to spearate into groups**    
**206 mosaic::ntiles to spearate into groups**    
...
**116-120 Data Wrangling on Languages**    
**255 Using Rank**  
**278 Using Rank**  
